      ...
      <table role="presentation" class="email-container" width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.06); border: 1px solid #e2e8f0;">
        ...
        <tr>
          <td class="header-padding" align="center" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); padding: 48px 40px; text-align: center;">
            ...
            <h1 style="margin: 0; color: #ffffff; font-size: 26px; font-weight: 800; tracking-tight: -0.02em;">🎉 Donation Verified</h1>
            <p style="margin: 8px 0 0 0; color: #fef3c7; font-size: 15px; font-weight: 500; line-height: 22px;">SpacECE India Foundation</p>
          </td>
        </tr>
        ...
        <tr>
          <td class="content-padding" style="padding: 40px 40px 32px 40px;">
                  ...
                  <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td class="detail-row detail-value" align="right" style="padding: 10px 0;">
                        <span style="display: inline-block; background-color: #d1fae5; color: #047857; padding: 4px 12px; border-radius: 9999px; font-size: 12px; font-weight: 700; border: 1px solid #a7f3d0;">
                          Verified ✅
                        </span>
                      </td>
                    </tr>
            ...
            <!-- CONDITIONAL CERTIFICATE CTA BUTTON -->
            ${
            certificateLink
            ? `
            <div style="text-align: center; margin-top: 36px;">
              ...
              <tr>
                <td style="padding: 16px 20px;">
                  <p style="margin: 0; font-size: 13px; line-height: 22px; color: #78350f;">
                    💚 Your contribution will directly help us create a meaningful impact. Thank you for being a part of this mission!
                  </p>
                </td>
              </tr>
            </table>
